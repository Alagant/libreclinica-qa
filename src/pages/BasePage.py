...
"""
Description: It contains common action methods and utilities for pages interactions, every other Page type-class should inherit from this BasePage class.
